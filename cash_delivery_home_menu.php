...
<body>
    <form class="add_customer_form" action="atm_simulator_out_action_1.php" method="post">
        ...
        <div class="flex-container">
            ...
            <div class="container">
            <a href="cash_delivery_debit.php" class="button">Withdraw Money</a>
            </div>
            <div class="container">
            <a href="cash_delivery_check_balance.php" class="button">Check Balance</a>
            </div>
            <div class="container">
            <a href="cash_delivery_show_receipt.php" class="button">Show Receipt</a>
            </div>
        ...
        <div class="flex-container">
            ...
            <div class="container">
            <a href="cash_delivery_exit.php" class="button" onclick="return confirm('Are you sure?')">Exit</a>
