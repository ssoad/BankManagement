...
<body>
    <form class="add_customer_form" action="edit_customer_action.php" method="post">
        ...
        <div class="flex-container">
            <div class=container>
                <label>Balance (BDT) : </label><br>
                <input name="balance" size="25" type="text" value="<?php echo $balance ?>" required />
            </div>
        </div>
        ...
        <div class="flex-container">
            <div class=container>
                ...
                <input name="nid" size="25" type="text" value="<?php echo $nid ?>" required />
            </div>
        </div>
        ...
        <div class="flex-container">
            ...
            <div  class=container>
                <select name="branch">
                    <option value="Gulshan" <?php if ($branch == 'Gulshan') {?> selected="selected" <?php }?>>Gulshan</option>
                    <option value="Dhanmondi" <?php if ($branch == 'Dhanmondi') {?> selected="selected" <?php }?>>Dhanmondi</option>
                    <option value="Banani" <?php if ($branch == 'Banani') {?> selected="selected" <?php }?>>Banani</option>
                    <option value="Bashundhara" <?php if ($branch == 'Bashundhara') {?> selected="selected" <?php }?>>Bashundhara</option>
                    <option value="Uttara" <?php if ($branch == 'Uttara') {?> selected="selected" <?php }?>>Uttara</option>
                </select>
            </div>
        </div>
        ...
        <div class="flex-container">
            <div class=container>
                ...
                <input name="card_no" size="25" type="text" value="<?php echo $card_no ?>" required />
            </div>
        </div>
